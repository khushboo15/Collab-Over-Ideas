...
class Message(models.Model):
    ...
    team = models.ForeignKey('Teams', on_delete=models.CASCADE, blank=True)
...
class MessageReference(models.Model):
    ...
    recipient = models.ForeignKey('User', blank=True, on_delete=models.CASCADE, related_name='recipients')
...
class Meetings(models.Model):
    ...
    scheduler = models.ForeignKey('User', on_delete=models.CASCADE, blank=True, related_name='scheduler')
