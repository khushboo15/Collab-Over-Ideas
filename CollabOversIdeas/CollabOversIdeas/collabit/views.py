...
def index(request):
    ...
    context = {}
    template = loader.get_template('collabit/index.html')
...
def index1(request):
    context = {}
    template = loader.get_template('collabit/index1.html')
    return HttpResponse(template.render(context, request))
...
def add_members(request):
    ...
    return redirect('feeds_dashboard')
...
def teams(request):
    ...
    template = loader.get_template('collabit/teams.html')
    return HttpResponse(template.render(context, request))
...
def feeds_dashboard(request):
    if request.session.get('username') is None:
        return redirect('index')
    context = get_dashboard_context(request)
    template = loader.get_template('collabit/feeds_dashboard.html')
    return HttpResponse(template.render(context, request))
...
def mini_tasks(request):
    ...
    template = loader.get_template('collabit/mini_tasks.html')
    return HttpResponse(template.render(context, request))
...
def mini_calendar(request):
    ...
    context['cal_users'] = TeamManagement.get_team_members(request.session.get('username'),
                                                           request.session.get('teamid'))
    template = loader.get_template('collabit/mini_calendar.html')
    return HttpResponse(template.render(context, request))
...
def mini_codes(request):
    ...
    template = loader.get_template('collabit/mini_codes.html')
    return HttpResponse(template.render(context, request))
...
def edit_profile(request):
    ...
    template = loader.get_template('collabit/edit_profile.html')
    if request.method == 'POST':
...
def file_upload(request):
    if request.session.get('username') is None:
        return redirect('index')
    context = get_dashboard_context(request)
    template = loader.get_template('collabit/file_upload.html')
